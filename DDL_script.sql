...
customer_id int,
shoe_id int not null,
rating enum ('MYCKET NÖJD', 'NÖJD', 'GANSKA NÖJD', 'MISSNÖJD'),
comment varchar(100),
created timestamp default current_timestamp,
lastUpdated timestamp default current_timestamp,
primary key(id),
...
insert into customers(first_name, last_name, location_id) values ('Liliana', 'Pitra', 50);
insert into customers(first_name, last_name, location_id) values ('Simon', 'Nöjd', 50);
insert into customers(first_name, last_name, location_id) values ('Valle', 'Rudhag', 51);
insert into customers(first_name, last_name, location_id) values ('Obi', 'One', 51);
insert into customers(first_name, last_name, location_id) values ('Sara', 'Svensson', 52);
...
insert into reviews(customer_id, shoe_id, rating, comment) values (1, 300, 1, 'very good');
insert into reviews(customer_id, shoe_id, rating, comment) values (2, 302, 2, 'nice');
insert into reviews(customer_id, shoe_id, rating, comment) values (3, 301, 4, 'Do not like');
insert into reviews(customer_id, shoe_id, rating, comment) values (3, 307, 1, 'Comfortable');
